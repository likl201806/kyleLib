...
@interface CMCustomeSegmentControlView : UIView
...
@property (nonatomic, strong) UIColor *backgroundHeightLightStartColor;   //高亮时的起始颜色
@property (nonatomic, strong) UIColor *backgroundHeightLightEndColor;   //高亮时的终点颜色
